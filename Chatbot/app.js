    ...
    methods: {
        sendMessage: function() {
            if(this.msg !== "" && this.chatHistory.length < 19) {
                this.chatHistory.push(`Unknown: ${this.msg}`)
        ...
        botReply: function(msg) {
            ...
            if(msg.includes("testing")) {
                ...
                setTimeout(function(){ 
                    chatHistory.pop();
                    chatHistory.push(`Nick (Bot): Searching for '${msg.split(" ")[msg.split(" ").indexOf("for")+1]}'...`)
                    setTimeout(function(){ 
                        window.open("https://google.com/search?q="+msg.split(" ")[msg.split(" ").indexOf("for")+1]);
                        chatHistory.pop();
                ...
                setTimeout(function(){ 
                    chatHistory.pop();
                    chatHistory.push(`Nick (Bot): Hello! I am happy to be talking with you!`)
                }, 2000);
                this.msg = "";
                ...
                setTimeout(function(){ 
                    chatHistory.pop();
                    chatHistory.push(`Nick (Bot): Sorry. Is there anyway I could do better?`)
                }, 2000);
                this.msg = "";
                ...
                setTimeout(function(){ 
                    ...
                    setTimeout(function(){ 
                        window.open("mailto:"+msg.split(" ")[msg.split(" ").indexOf("email")+1]);
                        chatHistory.pop();
